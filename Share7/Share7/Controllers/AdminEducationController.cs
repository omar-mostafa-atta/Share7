...
public class AdminEducationController : ControllerBase
{
    ...
    /// <summary>
    /// Rebuilds the curriculum node projection from the typed tree. Runs automatically after every
    /// tree edit; exposed here for the case where somebody changed the tables directly.
    /// </summary>
