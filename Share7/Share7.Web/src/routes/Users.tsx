...
import { CopyId, Def, DefList, Meter, Note, PageTitle, Pagination, SearchBox, Segmented } from '../components/ui/bits'
    ...
    <motion.div variants={listVariants} initial="hidden" animate="visible">
      ...
      <Card>
        ...
        <CardBody>
          ...
          {/* The server pages this list, so the table is handed one page and
              told not to page it again. */}
          <Pagination
            page={page}
            pageSize={pageSize}
            total={data.total}
