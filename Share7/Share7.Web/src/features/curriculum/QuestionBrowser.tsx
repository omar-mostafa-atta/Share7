...
import { Pagination, SearchBox, Segmented } from '../../components/ui/bits'
...
export function QuestionBrowser({
  ...
  useEffect(() => {
    setPage(1)
  }, [scopeId, scopeLevel, pool, search, onlyUnpaired, pageSize])

  const { result, loading } = useQuestionSearch(
    { scopeLevel, scopeId, pool, search, onlyUnpaired, page, pageSize },
    true,
  )
