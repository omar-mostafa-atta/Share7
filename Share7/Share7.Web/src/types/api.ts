...
/** `POST /api/admin/users` — answers with the new account as an `AdminUserListItemDto`. */
export interface CreateAdminUserRequest {
  username: string
  password: string

  /** One of `GET /api/admin/users/assignable-roles`, which depends on who is asking. */
  role: string
}
