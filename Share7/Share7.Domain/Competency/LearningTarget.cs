...
public class LearningTarget
{
    ...
    /// <summary>
    /// Set the first time somebody changes this target in the Studio.
    /// <para>
    /// **What makes re-importing a curriculum safe.** The official outcomes are somebody else's
    /// document and they are re-issued; a second import has to be able to bring in what changed
    /// without silently undoing the team's rewording of a line that was unclear. A target with a
    /// date here is the team's, and an import leaves it exactly as it is and says that it did.
    /// </para>
    /// </summary>
