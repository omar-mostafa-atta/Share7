...
public class Lesson
{
    ...
    /// <summary>
    /// **Compatibility copy.** Set when the lesson is retired: hidden from students, history kept.
    ...
    /// global query filter hides retired rows, so to those readers a retired lesson is simply gone.
    /// </summary>
