...
namespace Share7.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260812174811_CurrencyAndUserBalances")]
    partial class CurrencyAndUserBalances
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Share7.Domain.Commerce.Currency", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Share7.Domain.Commerce.UserCurrencyBalance", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Share7.Domain.Commerce.UserCurrencyBalance", b =>
                {
                    b.HasOne("Share7.Domain.Commerce.Currency", "Currency")
                        .WithMany("Balances")
